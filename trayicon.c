...
//			
//			AppendMenu(openedSlotList,MF_STRING,-1,"Å×½ºÆ® ¼­ºê");
//			
...
//					sprintf(menuStr,"%s ´Ý±â",slot[i].slotName);
...
//			AppendMenu(trayMenu,MF_STRING,WM_OPEN_PROGRAM,"¿­±â");
//			AppendMenu(trayMenu,MF_STRING,WM_EXIT_PROGRAM,"Á¾·á");
